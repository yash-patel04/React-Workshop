    ...
    <>
      <table className="table table-hover table-dark" border={2}>
        <tr>
          ...
          <th>FacultyName</th>
          <th>FacultyImage</th>
          <th>FacultyInitial</th>
          <th>FacultyDescription</th>
          <th>FacultyDateOfBirth</th>
          <th>id</th>
        </tr>
        {faculties.map((data) => (
          <tr>
            ...
            <td>{data.FacultyInitial}</td>
            <td>{data.FacultyDescription}</td>
            <td>{data.FacultyDateOfBirth}</td>
            <td>{data.id}</td>
          </tr>
        ))}
      </table>
